        ...
        <div className="relative z-10 p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-20 flex flex-col md:flex-row gap-4 md:gap-32 justify-center items-center bg-opacity-80 text-white">
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="font-bold text-sm ">
              <img src="../../../public/gif/food-delivery.gif" alt="" className="w-40 h-40 rounded-full"/>
            </div>
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="font-bold text-sm ">
              <img src="../../../public/gif/table.gif" alt="" className="w-40 h-40 rounded-full"/>
            </div>
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <div className="font-bold text-sm ">
              <img src="../../../public/gif/scooter.gif" alt="" className="w-40 h-40 rounded-full"/>
            </div>
