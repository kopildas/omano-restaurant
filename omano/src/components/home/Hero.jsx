    ...
    <>
      <div className="home md:home2">
        <div className="grid h-full grid-flow-col">
            <div className="flex flex-col items-start justify-center px-10 mt-10 mb-16 md:px-52">
            <p className="text-[1rem] font-mono tracking-wide">Welcome to Omano</p>
            <p className="text-[2.5rem] md:text-[3rem] font-bold tracking-wide">ENJOY YOUR <br/>FAVORITE FOOD <br/> WITH FAMILY.</p>
